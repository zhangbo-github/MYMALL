package com.mia.miamall.list.service.impl;
...
public class ListServiceImpl implements ListService {
    ...
    public static final String ES_INDEX="miamall";
    ...
    /**
     * 通过用户传入的参数在es中查出对应的结果集
     * @param skuLsParams
     * @return
     */
    @Override
    public SkuLsResult search(SkuLsParams skuLsParams) {
        // 先写dsl语句 ，使用java代码写， 相当于在kibana中写语句
        String query=makeQueryStringForSearch(skuLsParams);
        // 执行(创建执行对象)
        Search search = new Search.Builder(query).addIndex(ES_INDEX).addType(ES_TYPE).build();
        SearchResult searchResult =null;
        try {
            // 获取执行的结果： searchResult -- 变化成我们封装好的结果集对象
    ...
    private SkuLsResult makeResultForSearch(SkuLsParams skuLsParams,
...
System.out.println("es中查询出的skuLsInfo遍历： "+skuLsInfo.toString());
        }
System.out.println("================================================================");
        // skuLsInfo 对象 --
...
System.out.println("总条数："+searchResult.getTotal()+"     总页数："+totalPage);
System.out.println("================================================================");
...
System.out.println("valueId有过滤条件的"+valueId);
        }
        // 平台属性值添加
    ...
    private String makeQueryStringForSearch(SkuLsParams skuLsParams) {
        ...
        System.out.println("封装出来的es查询语句query="+query);
        return query;
    ...
    public void incrHotScore(String skuId) {
        ...
        /*每点击5次，就更新es中该sku的hostScore*/
        if (hotScore%timesToEs==0){
            // 更新es                         如：9.1=>10 / 9.9=>10
